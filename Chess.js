...
function coloring() {
    ...
    color.forEach(color => {
        ...
        if (a % 2 == 0) {
            color.style.backgroundColor = '#ffe9c5'
        }
        if (a % 2 !== 0) {
            color.style.backgroundColor = '#c5dbff'
        }
        // if (a % 2 == 0) {
...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        if (tog % 2 !== 0) {
            document.getElementById('tog').innerText = "THE MOVE BELONGS TO WHITE"
            document.getElementById('tog').style.color = "red"; 

            whosTurn('W')
        }
        if (tog % 2 == 0) {
            document.getElementById('tog').innerText = "THE MOVE BELONGS TO BLACK"
            document.getElementById('tog').style.color = "pink"; 
            whosTurn('B')
        }
